...
class primary_encoder_v2_no_pooler_for_con(nn.Module):
    ...
    def __init__(self,hidden_size,emotion_size,encoder_type="bert-base-uncased", use_ner=False):
        ...
        if use_ner:
            ...
            self.encoder_supcon.resize_token_embeddings(len(tokenizer))
